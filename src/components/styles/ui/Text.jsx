...
export const Text = styled.p`
  ...
  text-shadow: ${(props) =>
    props.$variant === 'primary'
      ? '-1px -1px 0 #fff, 1px -1px 0 #00fffa, -1px 1px 0 #00fffa, 1px 1px 0 #fff'
      : '-1px -1px 0 deepskyblue, 1px -1px 0 deepskyblue, -1px 1px 0 deepskyblue, 1px 1px 0 deepskyblue'};
  color: ${(props) =>
    props.$variant === 'primary' ? props.theme.colors.primary : 'black'};
  ...
  ${mobile} {
    ...
    padding: ${(props) =>
      props.$variant === 'primary'
        ? '15px 10px 40px 92px'
        : '38px 151px 40px 10px'};
    text-align: ${(props) => (props.$variant === 'primary' ? 'right' : 'left')};
  }
  ${desktop} {
    font-size: 28px;
    padding: 30px;
